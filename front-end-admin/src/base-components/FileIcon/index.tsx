...
function FileIcon({ variant, type, src, className, ...props }: FileIconProps) {
  return (
    <div className={className} {...props}>
      ...
      >
        {variant == 'file' && (
          <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex items-center justify-center text-white">
            {type}
          </div>
        )}
        {variant == 'image' && (
          <div className="image-fit absolute left-0 top-0 h-full w-full">
            <img
