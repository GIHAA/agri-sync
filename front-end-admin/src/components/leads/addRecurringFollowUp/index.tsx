  ...
  const schema = yup
    .object({
      title: yup
        ...
        .required(
          `${t(
            'lead.fields.followUpBy.validationMessage'
          )}`
        ),
        assignedTo: yup
        .string()
        ...
        .required(
          `${t(
            'lead.fields.inDays.validationMessage'
          )}`
        ),
    })
    .required()
  ...
  return (
    <form className="validate-form" onSubmit={handleSubmit(onSubmit)}>
       <div className="intro-y box mb-5 px-5 py-5">
            ...
            <div className="flex grid grid-cols-1 mt-5 mb-5 gap-7 md:grid-cols-2">
           <div className='font-medium mt-2'>{`${t('lead.fields.followUpBy.label')}`}</div> 
             <TomSelect
                       required
                      ...
                      >
                        ...
                        <optgroup label="Orders">
                          <option value="6">Has No Transaction</option>
                      ...
                      <InputElement
            label={`${t('lead.fields.inDays.label')}`}
            register={register}
            name="inDays"
            error={errors.inDays}
            required
      ...
      <div className="intro-y box mb-5 px-5 py-5">
        ...
        <InputElement
            ...
            id="title"
          />
        <div className='font-medium mt-2'> Available Tags : </div>
          </div>
...
export default AddRecurringFollowUp
