...
function SendProposalTemplate() {
  ...
  const schema = yup
    .object({
        ...
        .required(
          `${t(
            'contactManagement.fields.suppliers.fields.viewSuppliers.fields.purchase.fields.sendNotifications.fields.emailBody.validationMessage'
          )}`
        ),
        subject: yup
        .string()
  ...
  return (
    <form className="validate-form" onSubmit={handleSubmit(onSubmit)}>
      <div className="intro-y box mb-5 px-5 py-5">
              ...
              register={register}
              label={`${t('expensesForm.fields.attachDocument.placeolder')}`}
              variant="primary"
              btnLabel={`${t(
...
export default  SendProposalTemplate
