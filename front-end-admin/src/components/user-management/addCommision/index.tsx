...
function AddCommision() {
  ...
  const schema = yup
    .object({
      name: yup
        .string()
        .required(`${t('fixedCommission.fields.addCommisionType.fields.name.validationMessage')}`),
        minimumInvoiceCount: yup
        .string()
        .required(`${t('fixedCommission.fields.addCommisionType.fields.minimumInvoiceCount.validationMessage')}`),
        maximumInvoiceCount: yup
        .string()
        .required(
          `${t(
            'fixedCommission.fields.addCommisionType.fields.maximumInvoiceCount.validationMessage'
          )}`
        ),
        fixedRate: yup
        .string()
        .required(
          `${t(
            'fixedCommission.fields.addCommisionType.fields.fixedRate.validationMessage'
          )}`
        ),
    })
    .required()
    ...
    <form className="validate-form" onSubmit={handleSubmit(onSubmit)}>
      <div className="intro-y box mb-5 px-5 py-10">
        <div className="grid grid-cols-1 gap-7 md:grid-cols-1">
          <InputElement
            label={`${t(
              'fixedCommission.fields.addCommisionType.fields.name.label'
            )}`}
            register={register}
            name="name"
            placeholder={`${t(
              'fixedCommission.fields.addCommisionType.fields.name.placeolder'
            )}`}
            id="name"
            error={errors.name}
            required
          ...
          <InputElement
            label={`${t(
              'fixedCommission.fields.addCommisionType.fields.minimumInvoiceCount.label'
            )}`}
            register={register}
            name="minimumInvoiceCount"
            placeholder={`${t(
              'fixedCommission.fields.addCommisionType.fields.minimumInvoiceCount.placeolder'
            )}`}
          ...
          <InputElement
            label={`${t(
              'fixedCommission.fields.addCommisionType.fields.maximumInvoiceCount.label'
            )}`}
            register={register}
            name="maximumInvoiceCount"
            placeholder={`${t(
              'fixedCommission.fields.addCommisionType.fields.maximumInvoiceCount.placeolder'
            )}`}
          ...
          <SelectElement
            label={`${t(
              'fixedCommission.fields.addCommisionType.fields.saleType.label'
            )}`}
            register={register}
            name="saleType"
            id="saleType"
          ...
          <InputElement
            label={`${t(
              'fixedCommission.fields.addCommisionType.fields.fixedRate.label'
            )}`}
            register={register}
            name="fixedRate"
            placeholder={`${t(
              'fixedCommission.fields.addCommisionType.fields.fixedRate.placeolder'
            )}`}
            id="fixedRate"
            required
