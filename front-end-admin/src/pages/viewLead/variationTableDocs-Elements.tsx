...
import VariationTable from './components/variationTableDocs'
...
function VariationTableElementDocs({
  id,
  label,
  required,
  info,
...
export default VariationTableElementDocs

VariationTableElementDocs.defaultProps = {
  id: '',
  label: '',
  name: '',
  disabled: false,
