...
function Main() {
  ...
  return (
    <div className="">
            ...
            <h2 className="mr-auto text-lg font-medium ml-2">All Users <Button
                  variant="twitter"
        ...
        <div className="intro-y box mb-5 mt-5 px-5 py-5 ">
          ...
          <div className="  py-5" style={{ overflowY: 'auto' }}>
          ...
          <Table.Tr>
            ...
            <Table.Td>
             ...
             onClick={() => handleClick(SlideoverRegistry.editUserManagement)}>
                 <Lucide icon="Edit" className="w-4 h-4" /></Button> 
                 <Button variant="linkedin" className="mb-2 mr-1"  size="sm"
                 onChange={handleChange}
                 onClick={() => handleClick(SlideoverRegistry.viewUserManagement)}>
          <Lucide icon="Eye" className="w-4 h-4" /></Button> 
          <Button variant="danger" className="mb-2 mr-1"  size="sm"
                onChange={handleChange}
                      ...
                      >
     <Lucide icon="Trash" className="w-4 h-4" /></Button> 
