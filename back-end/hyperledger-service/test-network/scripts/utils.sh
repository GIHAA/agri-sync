...
function printHelp() {
  ...
  if [ "$USAGE" == "prereq" ]; then
    ...
    println "    -c <channel name> - Name of channel to create (defaults to \"seedtransectionchannel\")"
    ...
    println
    println " Examples:"
    println "   network.sh up createChannel -ca -c seedtransectionchannel -s couchdb "
    println "   network.sh up createChannel -bft -c seedtransectionchannel -s couchdb "
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn basic -ccp ../Seed-transfer-basic/chaincode-javascript/ ./ -ccl javascript"
    ...
    println
    println " Examples:"
    println "   network.sh deployCCAAS  -ccn basicj -ccp ../Seed-transfer-basic/chaincode-java"
    println "   network.sh deployCCAAS  -ccn basict -ccp ../Seed-transfer-basic/chaincode-typescript -ccaasdocker false"
  elif [ "$USAGE" == "cc" ] ; then
    println "Usage: "
    ...
    println "   network.sh cc package -ccn basic -ccp chaincode/Seed-transfer-basic/go -ccv 1.0.0 -ccl go"
    println "   network.sh cc invoke -c channel1 -ccic '{\"Args\":[\"CreateSeed\",\"Seed1\",\"red\",\"10\",\"fred\",\"500\"]}'"
    println "   network.sh cc query -c channel1 -ccqc '{\"Args\":[\"ReadSeed\",\"Seed1\"]}'"
    println
    ...
    println "      \033[0;32mdeployCC\033[0m - Deploy a chaincode to a channel (defaults to Seed-transfer-basic)"
