...
///import { seedsCouchDBRouter } from './SeedsCouchDB.router';
import { authenticateApiKey, fabricAPIKeyStrategy } from './auth';
import { healthRouter } from './health.router';
//import { healthCouchDBRouter } from './healthCouchDB.router';
import { jobsRouter } from './jobs.router';
//import { JobsCouchDBRouter } from './JobsCouchDB.router';
...
//     app.use('/', healthRouter);
//     app.use('/', healthCouchDBRouter);
//     app.use('/api/seeds', SeedsRouter);
//     app.use('/api/seedsCouchDB', seedsCouchDBRouter);
//     app.use('/api/jobs', authenticateApiKey, jobsRouter);
//     app.use('/api/jobsCouchDB', authenticateApiKey, JobsCouchDBRouter);
//     app.use('/api/transactions', authenticateApiKey, transactionsRouter);
